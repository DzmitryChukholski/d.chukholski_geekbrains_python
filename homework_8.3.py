...
class NumbersOnlyPlease(Exception):
    def __init__(self, txt):
        self.txt = txt


print('Для завершения цикла введите "stop"')
user_list = []
while True:
    try:
        ...
        if el == 'stop':
            break
        if not el.isdigit():
            raise NumbersOnlyPlease('Пожалуйста, вводите только числа')
        user_list.append(el)
    except NumbersOnlyPlease as user_error:
        print(user_error)
